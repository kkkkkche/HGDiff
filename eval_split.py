...
if __name__ == '__main__':
    ...
    parser.add_argument('--eval_end_index', type=int, default=0)
    parser.add_argument('--save', type=eval, default=True)
    parser.add_argument('--protein_root', type=str, default='/home/hc/irdiff/data/test_set')
    ...
    for example_idx, r_name in enumerate(tqdm(results_fn_list, desc='Eval')):
        r = torch.load(r_name, map_location=args.device)  # ['data', 'pred_ligand_pos', 'pred_ligand_v', 'pred_ligand_pos_traj', 'pred_ligand_v_traj']
    ...
    if args.save:
        eval_bond_length.plot_distance_hist_0(success_pair_length_profile,
